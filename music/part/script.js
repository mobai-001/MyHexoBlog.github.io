...
class CardProfile extends React.Component {constructor(...args) {super(...args);_defineProperty(this, "state",
    {
      ...
      { name: '鲤 - Level - 2', author: '鲤(Game)', img: '/MyHexoBlog.github.io/music/index/KOI/KOI-ICON.png', audio: '/MyHexoBlog.github.io/music/index/KOI/level2.mp3', duration: '3:35' },
      { name: '鲤 - Level - 3', author: '鲤(Game)', img: '/MyHexoBlog.github.io/music/index/KOI/KOI-ICON.png', audio: '/MyHexoBlog.github.io/music/index/KOI/level3.mp3', duration: '6:51' },
      { name: '鲤 - Level - 4', author: '鲤(Game)', img: '/MyHexoBlog.github.io/music/index/KOI/KOI-ICON.png', audio: '/MyHexoBlog.github.io/music/index/KOI/level4.mp3', duration: '4:10' },
      { name: '鲤 - Level - 5', author: '鲤(Game)', img: '/MyHexoBlog.github.io/music/index/KOI/KOI-ICON.png', audio: '/MyHexoBlog.github.io/music/index/KOI/level5.mp3', duration: '5:30' },
      { name: '鲤 - Level - 6', author: '鲤(Game)', img: '/MyHexoBlog.github.io/music/index/KOI/KOI-ICON.png', audio: '/MyHexoBlog.github.io/music/index/KOI/level6.mp3', duration: '3:49' },
      { name: '鲤 - Level - 7', author: '鲤(Game)', img: '/MyHexoBlog.github.io/music/index/KOI/KOI-ICON.png', audio: '/MyHexoBlog.github.io/music/index/KOI/level7.mp3', duration: '2:30' },
      { name: '鲤 - Level - 7_1', author: '鲤(Game)', img: '/MyHexoBlog.github.io/music/index/KOI/KOI-ICON.png', audio: '/MyHexoBlog.github.io/music/index/KOI/level7_1.mp3', duration: '1:18' },
      { name: '鲤 - Level - 8', author: '鲤(Game)', img: '/MyHexoBlog.github.io/music/index/KOI/KOI-ICON.png', audio: '/MyHexoBlog.github.io/music/index/KOI/level8.mp3', duration: '2:31' }],
